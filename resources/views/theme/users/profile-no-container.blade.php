  ...
  <!-- Users Posts -->
    <div class="justify-between flex items-end justify-between@md margin-bottom-md">
      <div class="justify-between flex items-end justify-between@md">
        ...
        <a href="/user/{{$user->username}}?type=favorite" class="btn {{request()->get('type') === 'favorite' ? 'btn--primary' : 'btn--subtle'}} btn--sm radius-full margin-right-xs" role="text">My Lists</a>
      </div>
    </div>
