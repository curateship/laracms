<section class="margin-bottom-lg">
    ...
    <li class="card">
        <div class="bg-light">
          <figure class="card__img img-blend corner-shadow" data-blend-pattern="0,0,1,0" data-blend-color="--color-bg-light" data-blend-height="100%">
            ...
            <img class="radius-md card-author-2" src="/assets/img/article-v3-img-1.jpg" alt="Card preview img">
          </figure>
