<section class="hero hero--overlay-layer position-relative padding-y-xxl" data-blend-pattern="0,0,1,0" style="background-image: url('/assets/img/intro-img-1.jpg')">
