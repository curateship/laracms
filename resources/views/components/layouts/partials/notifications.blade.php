<ul class="notif ">
  ...
  <li class="notif__item ">
    <a class="notif__link flex padding-sm" href="#0">
      <figure class="notif__figure margin-right-xs color-primary" aria-hidden="true">
        <img src="https://codyhouse.co/app/assets/img/notifications-img-2.jpg" alt="user picture">
      </figure>
  ...
  <li class="notif__item ">
    <a class="notif__link flex padding-sm" href="#0">
      <figure class="notif__figure margin-right-xs color-primary" aria-hidden="true">
        <img src="https://codyhouse.co/app/assets/img/notifications-img-1.jpg" alt="user picture">
      </figure>
  ...
  <li class="notif__item ">
    <a class="notif__link flex padding-sm" href="#0">
      <figure class="notif__figure margin-right-xs color-primary" aria-hidden="true">
        <img src="https://codyhouse.co/app/assets/img/notifications-img-4.jpg" alt="user picture">
      </figure>

      <div class="flex-grow margin-right-xs">

        <div class="padding-top-xxxxs">
          <p class="text-sm"><i class="font-semibold">Paul Brown</i> liked your photo.</p>
          <p class="text-xs color-contrast-medium margin-top-xxxxs"><time>1 week ago</time></p>
        </div>
      </div>
