<ul class="sticky-sharebar__list position-fixed position-sticky top-xs@xs padding-sm">
  ...
  <li class="padding-x-xs margin-top-sm">
    <button class="reset comments__vote-btn js-comments__vote-btn js-tab-focus" aria-controls="modal-explorer">
      <div class="comments__vote-icon-wrapper">
...
<!-- List Modal -->
<div class="modal modal--animate-fade bg-black bg-opacity-90% padding-x-md padding-y-lg js-modal" id="modal-explorer" data-modal-first-focus=".js-autocomplete__input">
  <div class="modal__content explorer width-100% max-width-xs max-height-100% overflow-auto margin-x-auto flex flex-column bg radius-md shadow-md js-explorer" data-autocomplete-dropdown-visible-class="explorer--results-visible" data-autocomplete-searching-class="explorer--searching">
    <div class="explorer__input-wrapper flex-shrink-0">
      <input class="reset explorer__input width-100% js-autocomplete__input" type="text" name="autocomplete-input" id="autocomplete-input" placeholder="Search Lists..." autocomplete="off">
    ...
    <div class="explorer__results flex-grow js-autocomplete__results">
      <ul class="explorer__list js-autocomplete__list">
        ...
        <li class="js-autocomplete__item is-hidden" data-autocomplete-template="no-results" aria-hidden="true">
        ...
        <li class="js-autocomplete__item is-hidden" data-autocomplete-template="button">
          <button class="reset explorer__result">
            <!-- icon -->
            <span class="explorer__icon margin-right-xxs" aria-hidden="true" data-autocomplete-icon data-autocomplete-html></span>
            
            <!-- label -->
            <i class="text-truncate padding-right-xs" data-autocomplete-label></i>
