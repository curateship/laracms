      ...
      <div class="grid gap-md items-start">
        ...
        <div class="col-10@md col-9@xxs">
          ...
          <div class="articles-v3__author display@md padding-top-md">
            ...
            <!-- Author Image -->
            <a href="/user/{{$post->author()->username}}" class="articles-v3__author-img">
            ...
            <div class="text-component text-sm line-height-xs text-space-y-xxs">
              <p><a href="/user/{{$post->author()->username}}" class="articles-v3__author-name" rel="author">{!! $post->author() != null ? $post->author()->name : '<span style="font-weight: bold;color:red;">Deleted User</span>' !!}</a></p>
