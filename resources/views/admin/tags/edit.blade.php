  ...
  <!-- Select Category Dropdown Autocomplete -->
      <div class="autocomplete position-relative select-auto js-select-auto js-autocomplete margin-bottom-md" data-autocomplete-dropdown-visible-class="autocomplete--results-visible">
          ...
          <select class="js-select-auto__select">
              <optgroup>
                  @foreach(\App\Models\TagsCategories::all() as $category)
                      <option value="{{$category->id}}" {{$category->id == $tag->category_id ? 'selected' : ''}}>{{$category->name}}</option>
                  @endforeach
              </optgroup>
          </select>
          ...
          <div class="select-auto__input-wrapper">
              <input class="form-control js-autocomplete__input js-select-auto__input" type="text" name="tag_category" id="tag_category" value="{{\App\Models\TagsCategories::find($tag->category_id)->name}}" placeholder="Select a Tag Category" autocomplete="off">
