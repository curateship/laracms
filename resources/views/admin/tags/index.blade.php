    ...
    <div class="card" data-table-controls="table-1"><!-- Content Table Column -->
      ...
      <div class="controlbar--sticky flex justify-between">
        ...
        <nav class="breadcrumbs text-based padding-left-sm padding-sm" aria-label="Breadcrumbs">
          ...
          <!-- Delete Confirmation -->
          <div id="delete-tag-dialog" class="dialog dialog--sticky js-dialog" data-animation="on">
              <div class="dialog__content max-width-xxs" role="alertdialog" aria-labelledby="dialog-sticky-title" aria-describedby="dialog-sticky-description">
                  <div class="text-component">
                      <h4 id="dialog-sticky-title">Are you sure what you want to delete selected tag(-s)?</h4>
                  </div>
                  <footer class="margin-top-md">
                      <div class="flex justify-end gap-xs flex-wrap">
                          <button class="btn btn--subtle js-dialog__close">Cancel</button>
                          <button id="accept-delete-tags" class="btn btn--accent">Delete</button>
                      </div>
                  </footer>
                  <input type="hidden" id="delete-tags-list">
              </div>
          </div>
      </div>
                ...
                <div class="int-table__inner margin-bottom-xs">
                    <table class="int-table__table" aria-label="Interactive table example">
                        ...
                        <tr class="int-table__row">
                            <td class="int-table__cell">
                                <div class="custom-checkbox int-table__checkbox">
                                    <input class="custom-checkbox__input js-int-table__select-all tags-list-checkbox-all" type="checkbox" aria-label="Select all rows" />
                        ...
                        @foreach($tags as $tag)
                            <tr class="int-table__row">
                                <th class="int-table__cell" scope="row">
                                    <div class="custom-checkbox int-table__checkbox">
                                        <input class="custom-checkbox__input js-int-table__select-row tag-list-checkbox" data-tag-id="{{$tag->id}}" type="checkbox" aria-label="Select this row" />
                                        <div class="custom-checkbox__control" aria-hidden="true"></div>
                                    </div>
                                </th>
                                <td class="int-table__cell flex">
                                    ...
                                    <div class="line-height-xs padding-top-xxxs padding-left-xxs">
                                        <div class=""><a href="{{route('admin.tags.edit', $tag->id)}}" class="link-subtle">{{ \Str::limit( $tag->name, 65) }}</a></div>
                                    </div>
                                </td>
                                ...
                                <!-- Action Dropdown -->
                                <td class="int-table__cell">
                                    <button class="reset int-table__menu-btn margin-left-auto js-tab-focus" data-label="Edit row" aria-controls="menu-example-{{$tag->id}}">
                                    ...
                                    <menu id="menu-example-{{$tag->id}}" class="menu js-menu">
                                        <!-- Preview Action -->
                                        <li role="menuitem">
                        <span class="menu__content js-menu__content">
                          ...
                          <span><a class="text-decoration-none color-inherit" href="#" target="_blank">Preview</a></span>
                        </span>
                                        </li>
                                        <!-- Delete Action -->
                                        <li role="menuitem">
                        <span class="menu__content js-menu__content">
                          ...
                          <span class="delete-tag-context-menu" data-tag-id="{{ $tag->id }}">Delete</span>
                        </span>
                                        </li>
                                    </menu>
                                    <!-- Action Dropdown END-->
