    ...
    <div class="grid gap-md justify-between">
        <div class="col-12@md"><!-- 👇 Col 12 -->
            <div class="card" data-table-controls="table-1"><!-- Content Table Column -->
                        ...
                        <nav class="breadcrumbs text-based padding-left-sm padding-sm" aria-label="Breadcrumbs">
                            <ol class="flex flex-wrap gap-xxs">
                                ...
                                <li class="breadcrumbs__item color-contrast-high" aria-current="page">
                                    <a href="/admin/pages?status={{$status}}" class="color-inherit link-subtle">{{$status}}</a>
                                </li>
                            </ol>
                        </nav>
                    </div>
                    ...
                    <div class="flex flex-wrap items-center justify-between margin-right-sm">
                        <div class="flex flex-wrap">
                            <menu class="menu-bar js-int-table-actions__no-items-selected js-menu-bar">
                                <div class="menu-bar__item"><a href="{{ route('admin.pages.create') }}" role="menuitem">
                                ...
                                @foreach($pages as $page)
                                    <tr class="int-table__row">
                                        <th class="int-table__cell" scope="row">
                                            <div class="custom-checkbox int-table__checkbox">
                                                <input class="custom-checkbox__input js-int-table__select-row post-list-checkbox" data-page-id="{{$page->id}}" type="checkbox" aria-label="Select this row" />
                                                <div class="custom-checkbox__control" aria-hidden="true"></div>
                                            </div>
                                        </th>
                                        <td class="int-table__cell flex">
                                            ...
                                            <div class="line-height-xs padding-top-xxxs padding-left-xxs">
                                                <div class=""><a href="{{ route ('admin.pages.edit', $page->slug) }}" class="link-subtle">{{ \Str::limit( $page->title, 65) }}</a></div>
                                            </div>
                                        </td>

                                        <!-- Publish and Date -->
                                        <td class="int-table__cell">{{ $page->status }}</td>
                                        <td class="int-table__cell">{{ $page->created_at->diffForHumans() }}</td>

                                        <!-- Action Dropdown -->
                                        <td class="int-table__cell">
                                            <button class="reset int-table__menu-btn margin-left-auto js-tab-focus" data-label="Edit row" aria-controls="menu-example-{{$page->id}}">
                                            ...
                                            <menu id="menu-example-{{$page->id}}" class="menu js-menu">
                                                ...
                                                <li role="menuitem">
                                                    <span class="menu__content js-menu__content">
                                                      ...
                                                      <span class="delete-page-context-menu" data-page-id="{{ $page->id }}">Delete</span>
                                                    </span>
                                                </li>
                                            </menu>
                ...
                <div id="delete-page-dialog" class="dialog dialog--sticky js-dialog" data-animation="on">
                    <div class="dialog__content max-width-xxs" role="alertdialog" aria-labelledby="dialog-sticky-title" aria-describedby="dialog-sticky-description">
                        <div class="text-component">
                            <h4 id="dialog-sticky-title">Are you sure what you want to delete selected page?</h4>
                        </div>
                        <footer class="margin-top-md">
                            <div class="flex justify-end gap-xs flex-wrap">
                                <button class="btn btn--subtle js-dialog__close">Cancel</button>
                                <button id="accept-delete-pages" class="btn btn--accent">Delete</button>
                            </div>
                        </footer>
                        <input type="hidden" id="delete-pages-list">
                    </div>
                </div>
                <!-- Pagination -->
                <div class="margin-top-auto border-top border-contrast-lower"></div><!-- Divider -->
                @include('components.layouts.partials.pagination', ['items' => $pages])
