...
<! Table-->
<d class="margin-top-auto border-top border-contrast-lower opacity-40%"></div><!-- Divider -->
<d class="padding-md">
<fm action="{{ route('admin.categories.store') }}" method='post'>@csrf

  ieldset class="margin-bottom-xxs">
  ...
  iv class="flex justify-end gap-xs">
