        ...
        <div class="card" data-table-controls="table-1"><!-- Content Table Column -->
          ...
          <div class="margin-top-auto border-top border-contrast-lower border-opacity-30%"></div><!-- Divider -->
            <div class="padding-md">
              <form action="{{ route('admin.comments.store') }}" method='post'>@csrf

              <div>
                <textarea class="margin-bottom-sm form-control width-100%" name="the_comment" id="post_comment" placeholder="Enter a Comment" rows="5">{{ old("the_comment") }}</textarea>
              </div>
