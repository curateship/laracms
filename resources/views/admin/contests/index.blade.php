                    ...
                    <div class="flex flex-wrap items-center justify-between margin-right-sm">
                        <div class="flex flex-wrap">
                            <menu class="menu-bar js-int-table-actions__no-items-selected js-menu-bar">
                                <div class="inline-flex items-baseline padding-x-sm">
                                    ...
                                    <div class="select inline-block js-select" data-trigger-class="reset text-sm color-contrast-high text-underline inline-flex items-center cursor-pointer js-tab-focus">
                                        <select name="selectThis" id="statusFilter">
                                            ...
                                            <option value="open" {{request()->get('status') == 'open' ? 'selected' : ''}} data-counter="{{$counters['open']}}">Open</option>
                                            <option value="close" {{request()->get('status') == 'close' ? 'selected' : ''}} data-counter="{{$counters['open']}}">Close</option>
                                        </select>
                                ...
                                <!-- Posts Modal -->
                                <div id="posts-modal" class="modal modal--animate-translate-down flex flex-center bg-black bg-opacity-90% padding-md js-modal">
                                    <div class="modal__content width-100% max-width-sm max-height-100% overflow-auto bg radius-md inner-glow shadow-md flex flex-column" role="alertdialog" aria-labelledby="modal-title-4" aria-describedby="modal-description-4">
                                        <header class="bg-contrast-lower bg-opacity-50% padding-y-sm padding-x-md flex items-center justify-between flex-shrink-0">
                                            <h1 id="modal-title-4" class="text-truncate text-md">Posts (<span id="modal-posts-count"></span>)</h1>
                                        ...
                                        <div class="padding-md col-15@md" id="posts-list-content">
                            ...
                            <table class="int-table__table" aria-label="Interactive table example">
                                ...
                                @foreach($contests as $contest)
                                    <tr class="int-table__row">
                                        ...
                                        <td class="int-table__cell">
                                            <div class="font-bold show-posts-modal cursor-pointer contest-posts-cell" data-contest-id="{{$contest->id}}">{{ $contest->posts_count }}</div>
                                        </td>
