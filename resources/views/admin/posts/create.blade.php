...
<div class="container max-width-adaptive-lg">
  ...
  <div class="margin-top-auto border-top border-contrast-lower opacity-40%"></div><!-- Divider -->
    ...
    <fieldset class="margin-bottom-md">
      ...
      <!-- input -->
      <div class="select-auto__input-wrapper">
        <input class="form-control js-autocomplete__input js-select-auto__input" type="text" name="autocomplete-input-id" id="autocomplete-input-id" placeholder="Select Content Type" autocomplete="off">
